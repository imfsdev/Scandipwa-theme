...
export class ProductActionsContainer extends PureComponent {
    ...
    containerFunctions = {
        ...
        getIsOptionInCurrentVariant: this.getIsOptionInCurrentVariant.bind(
            this
        ),
        setQuantity: this.setQuantity.bind(this),
        setGroupedProductQuantity: this._setGroupedProductQuantity.bind(this),
        clearGroupedProductQuantity: this._clearGroupedProductQuantity.bind(
            this
        ),
        getIsConfigurableAttributeAvailable: this.getIsConfigurableAttributeAvailable.bind(
            this
        ),
    };
    ...
    static getMinQuantity(props) {
        ...
        const { stock_item: { min_sale_qty: minVariantQty } = {} } =
    ...
    static getMaxQuantity(props) {
        ...
        const { stock_item: { max_sale_qty: maxVariantQty } = {} } =
            variants[configurableVariantIndex] || {};
    ...
    getIsConfigurableAttributeAvailable({ attribute_code, attribute_value }) {
        ...
        const isAttributeSelected = Object.hasOwnProperty.call(
            parameters,
            attribute_code
        );
        ...
        return variants.some(({ stock_status, attributes }) => {
            const { attribute_value: foundValue } =
