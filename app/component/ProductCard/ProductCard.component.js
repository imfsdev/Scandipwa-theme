...
export default class ProductCard extends PureComponent {
    static propTypes = {
        ...
        availableVisualOptions: PropTypes.arrayOf(
            PropTypes.shape({
    ...
    renderTierPrice() {
        ...
        return <TierPrices product={productOrVariant} isLowestPrice />;
    }
    ...
    renderReviews() {
        const {
            product: { review_summary: { rating_summary } = {} },
        } = this.props;
        if (!rating_summary) return null;

        return (
            <div block="ProductCard" elem="Reviews">
    ...
    renderAdditionalProductDetails() {
        ...
        const {
            product_list_content: { attribute_to_display } = {},
        ...
        return (
            <div block="ProductCard" elem="Brand" mods={{ isLoaded: !!brand }}>
                <ProductAttributeValue attribute={brand} isFormattedAsText />
            </div>
        );
    }
    ...
    render() {
        const { children, mix, isLoading } = this.props;
        const {
        ...
        return (
            <li block="ProductCard" mix={mix}>
                ...
                <AddToCart
                    ...
                    mix={{ block: 'ProductLinks', elem: 'AddToCart' }}
                    quantity={quantity}
