...
export default class ProductAttributeValue extends PureComponent {
    ...
    renderMultiSelectAttribute() {
        ...
        const labelsArray = attribute_value
            .split(",")
            .reduce((labels, value) => {
        ...
        return this.renderStringValue(
            labelsArray.length ? labelsArray.join(", ") : __("N/A")
        );
    }
    ...
    renderPlaceholder() {
        return <div block="ProductAttributeValue" elem="Placeholder" />;
    }
    ...
    renderColorValue(color, label) {
        ...
        return (
            ...
            >
                <button block="ProductAttributeValue" elem="ColorAddToCart">
                    Add to Cart
                </button>
            </data>
        );
